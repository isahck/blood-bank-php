            ...
            <div class="cardBox">
                <div class="card">
                    ...
                    <div>
                        ...
                        <?php 
                        $s = mysqli_query($conn, "SELECT * FROM `request` WHERE user_id = '$uid' ");
                ...
                <div class="card">
                    <div>
                        ...
                        <?php 
                        $s = mysqli_query($conn, "SELECT * FROM `request` WHERE user_id = '$uid' AND status='Approved'");
                        $coin = mysqli_num_rows($s);
                        ?>
                        <div class="cardName">Total: <?php echo $coin;?></div>
                    </div>
                ...
                <div class="card">
                    <div>
                        ...
                        <?php 
                        $s = mysqli_query($conn, "SELECT * FROM `request` WHERE user_id = '$uid' AND status='pending'");
                        $coin = mysqli_num_rows($s);
                        ?>
                        <div class="cardName">Total: <?php echo $coin;?></div>
                    </div>
                ...
                <div class="card">
                    <div>
                        ...
                        <?php 
                        $s = mysqli_query($conn, "SELECT * FROM `request` WHERE user_id = '$uid' AND status='Rejected'");
                        $coin = mysqli_num_rows($s);
                        ?>
                        <div class="cardName">Total: <?php echo $coin;?></div>
                    </div>
                ...
                <div class="recentOrders">
                    ...
                    <table>
                        ...
                        <?php
                            ...
                            $count = 1;
                            $s = mysqli_query($conn, "SELECT * FROM `request` WHERE user_id = '$uid' ORDER BY requested_at DESC LIMIT 5");
                            if ($s) {
