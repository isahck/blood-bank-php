<?php
    ...
    if (isset($_POST['request_blood'])) {
        ...
        if ($q > $get_quant) {
          ...
          $a = mysqli_query($conn, "INSERT INTO `request` (request_id,user_id,blood_group,blood_quantity,blood_id,reson,status)
    ...
    <?php include_once 'includes/topbar.php' ?>
          ...
          <div class="reques">
            <div class="form">
              ...
              <div class="form-field">
                <input type="text" readonly name="user_name" value="<?php echo $n; ?>" required>
              </div>
