...
if (isset($_POST['login'])) {
    $e = $_POST['donor_email'];
    $p = $_POST['password'];
    $l = mysqli_query($conn,"SELECT * FROM `donator` WHERE donor_email = '$e' AND password = '$p'");
    ...
    <div class="box-login">
        <form action="" method="post" class="box-form">
            ...
            <div class="links">
                ...
                <p>dont have account <a class="create register-page-link" href="donor-register.php">create</a></p>
            </div>
        </form>
    </div>
