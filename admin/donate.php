          ...
          <div class="reques">
            <div class="form">
              ...
              <div class="form-field">
                <select name="user_donator_name" class="blood_po" require style="width: 100%">
                <option value="Select Blood Group">user name</option>
                <?php
                  $s = mysqli_query($conn, "SELECT * FROM `users`");
